...
function request(url, data, callback) {
    ...
    // Passa a resposta para a função de callback, quando a requisição for concluída
...
// register.php
function register() {
    request('php/registrarUsuario.php', '#registerForm', function(data) {
        document.getElementById('errs').innerHTML = "";
        var transition = document.getElementById('errs').style.transition;
        document.getElementById('errs').style.transition = "none";
        document.getElementById('errs').style.opacity = 0;
        try {
            ...
            // Display dos erros para o usuário
